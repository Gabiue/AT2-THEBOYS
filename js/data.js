...
const personagens = [
  ...
  const perguntas = [
    ...
    {
      id: 6,
      enunciado: "O que te move a agir quando ninguém está olhando?",
      opcoes: [
        {
          texto: "A certeza de que o sistema precisa funcionar, com ou sem plateia.",
          scorePrincipal: 2,
          afinidade: { stanedgar: 3, noir: 2, victoria: 1 }
        },
        {
          texto: "A sensação de que ainda tenho algo a provar pra mim mesmo.",
          scorePrincipal: 4,
          afinidade: { atrain: 3, hughie: 2, mm: 1 }
        },
        {
          texto: "A necessidade de que as pessoas reconheçam o que eu valho.",
          scorePrincipal: 7,
          afinidade: { homelander: 3, thedeep: 2, butcher: 1 }
        }
      ]
    },
    ...
    {
      id: 7,
      enunciado: "Como você lida com quem está acima de você na hierarquia?",
      opcoes: [
        {
          texto: "Respeito enquanto for útil, mas sempre com um plano próprio.",
          scorePrincipal: 2,
          afinidade: { victoria: 3, stanedgar: 2, noir: 1 }
        },
        {
          texto: "Questiono quando necessário, mas tento trabalhar dentro do sistema.",
          scorePrincipal: 4,
          afinidade: { hughie: 3, mm: 2, atrain: 1 }
        },
        {
          texto: "Não aceito bem ordens — autoridade precisa ser justificada.",
          scorePrincipal: 7,
          afinidade: { butcher: 3, homelander: 2, thedeep: 1 }
        }
      ]
    },
    ...
    {
      id: 8,
      enunciado: "Quando você tem poder sobre uma situação, qual é seu instinto?",
      opcoes: [
        {
          texto: "Usá-lo da forma mais silenciosa e eficiente possível.",
          scorePrincipal: 2,
          afinidade: { noir: 3, stanedgar: 2, victoria: 1 }
        },
        {
          texto: "Usá-lo com responsabilidade, mesmo que isso custe algo.",
          scorePrincipal: 4,
          afinidade: { mm: 3, hughie: 2, atrain: 1 }
        },
        {
          texto: "Deixar claro que eu tenho esse poder.",
          scorePrincipal: 7,
          afinidade: { homelander: 3, thedeep: 2, butcher: 1 }
        }
      ]
